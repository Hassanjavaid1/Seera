...
function Contact() {
  return (
    <section className="relative group bg-[#2A2B2C] duration-200 hover:bg-[#8C49E9] cursor-pointer m-3 p-4 rounded-xl lg:p-6">
      <h1 className="text-4xl py-4 mr-10 lg:text-[48px]">
        Let's{" "}
        <span className="text-[#8C49E9] group-hover:text-white">
          Collaborate
        </span>
      </h1>
      <div className="absolute top-[19px] right-[12px] flex items-center justify-center bg-white text-[#8C49E9] w-[49px] h-[49px] rounded-full">
